...
type PositionReq struct {
	g.Meta    `path:"/backend/position/add" tags:"Position" method:"post" summary:"Your first position api"`
...
type PositionDeleteReq struct {
	...
	Id     uint `v:"min:1#请选择需要删除的手工位图id" dc:"手工位图id"`
}

type PositionDeleteRes struct{}

type PositionUpdateReq struct {
	g.Meta    `path:"/backend/position/update/{Id}" method:"post" tags:"内容" summary:"修改手工位图接口"`
